...
public class Formation360 : FormationPattern
{
    public static FormationManager.Location[] locations = new FormationManager.Location[] { new FormationManager.Location(Vector3.zero, 0),
                                                                                            new FormationManager.Location(new Vector3(-2, 0, -2), 0),
                                                                                            new FormationManager.Location(new Vector3(2, 0, -2), 0),
                                                                                            new FormationManager.Location(new Vector3(-4, 0, -2), -90),
                                                                                            new FormationManager.Location(new Vector3(4, 0, -2), 90),
                                                                                            new FormationManager.Location(new Vector3(-4, 0, -4), -90),
                                                                                            new FormationManager.Location(new Vector3(4, 0, -4), 90),
                                                                                            new FormationManager.Location(new Vector3(-2, 0, -6), -135),
                                                                                            new FormationManager.Location(new Vector3(2, 0, -6), 135),
                                                                                            new FormationManager.Location(new Vector3(0, 0, -8), 180),
                                                                                          };
